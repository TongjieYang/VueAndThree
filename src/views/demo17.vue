...
export default {
  ...
  methods: {
    ...
    mesh.translateZ(50);
    let geometry2 = new three.BoxGeometry(30, 30, 30); //创建一个立方体几何对象Geometry
    let material2 = new three.MeshLambertMaterial({
      color: 0xff00ff,
    });
    var newMesh2 = new three.Mesh(geometry2,material2);
    newMesh2.copy(mesh);
    this.scene.add(newMesh2);
